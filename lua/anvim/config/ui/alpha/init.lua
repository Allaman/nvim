...
local buttons = {
  ...
  val = {
    ...
    dashboard.button("f", "  Find File", ":" .. require("anvim.utils").telescope_find_files() .. "<CR>"),
...
local header = {
  ...
  val = require("anvim.config.ui.alpha.headers")["random"],
  -- val = require("anvim.config.alpha.headers").banners.sharp,
  opts = {
    position = "center",
    hl = "AlphaHeader",
  },
